...
public class highBasketAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Move the lift to the high basket position and wait for it to complete
        lift.liftHighBasket(); // Move the lift to the high basket position
        lift.waitForLiftMovement(); // Wait for the lift to reach its target
        ...
        TrajectoryActionBuilder builder = drive.actionBuilder(startPose)
                ...
                .strafeTo(new Vector2d(-48, -61)) // Move to basket position location
